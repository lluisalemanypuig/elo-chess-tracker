...
export const ROUTES = {
	...
	ICON_HOME_PAGE: '/icon/homepage',
	TITLE_LOGIN_PAGE: '/title/login-page',
	...
	QUERY_HTML_TIME_CONTROLS: '/query/html/time-controls',
	QUERY_HTML_TIME_CONTROLS_UNIQUE: '/query/html/time-controls-unique',
	...
	PAGE_USER_PASSWORD_CHANGE: '/page/user/password-change',
	...
	GAME_EDIT_TITLE: '/game/edit-title',
	GAME_EDIT_RESULT: '/game/edit-result',

	CHALLENGE_SEND: '/challenge/send',
	CHALLENGE_ACCEPT: '/challenge/accept',
	CHALLENGE_DECLINE: '/challenge/decline',
	CHALLENGE_SET_RESULT: '/challenge/set-result',
