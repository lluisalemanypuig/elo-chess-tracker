...
import { getPageGraphFull, getPageGraphOwn, postRecalculateGraphs } from '@server/graphs';
...
import { postQueryGameListAll, postQueryGameListOwn } from '@server/query-games';
